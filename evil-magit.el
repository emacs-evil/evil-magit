...
(defvar evil-magit-section-map-bindings
  '((magit-commit-section-map "v" 'set-mark-command 'magit-revert-no-commit)
    (magit-commit-section-map "o" 'magit-revert-no-commit 'magit-submodule-popup)

    (magit-file-section-map "X"    'magit-file-untrack) ; was K
    (magit-file-section-map "v"    'set-mark-command 'magit-reverse)
    (magit-file-section-map "o"    'magit-reverse 'magit-submodule-popup) ; was v
    (magit-file-section-map "j"    'evil-next-visual-line 'magit-diff-visit-file-worktree)
    (magit-file-section-map "\C-j" 'magit-section-forward 'magit-diff-visit-file-worktree)

    (magit-hunk-section-map "v"    'set-mark-command 'magit-reverse)
    (magit-hunk-section-map "o"    'magit-reverse 'magit-submodule-popup) ; was v
    (magit-hunk-section-map "j"    'evil-next-visual-line 'magit-diff-visit-file-worktree)
    (magit-hunk-section-map "\C-j" 'magit-section-forward 'magit-diff-visit-file-worktree)

    (magit-staged-section-map "v" 'set-mark-command 'magit-reverse)
    (magit-staged-section-map "o" 'magit-reverse 'magit-submodule-popup))) ; was v

;;;###autoload
(defun evil-magit-add-section-bindings ()
  "Revert bindings in section maps generated by evil-magit"
  (interactive)
  (loop for (map key evil-magit-cmd magit-cmd) in evil-magit-section-map-bindings
        do
        (evil-magit-define-key map key evil-magit-cmd magit-cmd)))
(evil-magit-add-section-bindings)
